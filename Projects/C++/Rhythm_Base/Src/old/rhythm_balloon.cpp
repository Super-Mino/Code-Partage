...
class Beats_Container //Une file de beat/impact/rythme, unité de temps : microseconde
{
	...
	protected:
		...
		double m_min_resp_offset_tolerance = 1000000; //La plage temporelle avant l'arrivé d'un beat où une réaction peut être acceptée; en µs. Exemple, si la position temporelle du beat est à 7, et que cette plage est de 2, aucune réation avant la position 5 ne sera comptabilisé pour ce beat.  		
